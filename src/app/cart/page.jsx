...
const Page = () => {
  ...
  if (!mounted) {
    // fallback to avoid hydration error
    return (
        ...
        <div className="container">
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-1'>
              <Link className='text-white text-[14px] font-medium leading-[18.2px] tracking-common' href={"/"} >Home</Link>
              <span className='text-white font-bold'>/</span>
              <p className='text-white text-[14px] font-medium leading-[18.2px] tracking-common'>Cart</p>
            </div>
          </div>
        </div>
      </div>
...
const ProductRow = ({ image, title, price, id }) => {
